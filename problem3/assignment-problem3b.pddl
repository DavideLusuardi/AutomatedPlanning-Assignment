; Problem file for the Problem 3 of APTP Assignment

(define (problem problem3b) (:domain assignment3)
    (:objects 
        robot1 robot2 - robot
    ...
    (:init
        ...
        (carrier_at carrier1 depot) (carrier_at carrier2 depot)
        ...
        (= (capacity carrier1) 4) (= (capacity carrier2) 4)
    )
