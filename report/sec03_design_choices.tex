...
is used: we assume that when a crate is delivered is no more available to be picked up or moved. % TODO: repeated
...
In Problem 3, the actions have been transformed into durative actions, specifying appropriate durations.
